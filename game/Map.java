...
public class Map {
    ...
    private Object[][] map=new Object[][]{
            ...
            {null,new Object("Hall Left", "You can barely recognize a door.",null),new Object("Red Door", null,null),new Object("Storage", "You are in a large storage bay filled with shelves, containers and other stuff. There are enough lights for you to see.",new Items[]{new Items("crowbar","Could be used to force open a door.",false)}),new Object("Red Door",null,null),new Object("Hall Right", "You can barely perceive a door and the hallway.\nConstant flashes of light are emitted from a seemingly broken door.",null),null},
            {null,new Object("Door", null,null),null,null,null,new Object("Door", null,null),null},
            ...
            {null,new Object("Breach", "It looks like the  ship was hit here. The ship will get destroyed and you will die if you don't find a way out.",new Items[]{new Items("Keycard for a Red Door","A keycard with a red clearance level",false)}),new Object("Door", null,null),new Object("Hall Center", "You are standing in the middle of a large intersection.",null),new Object("Door", null,null),new Object("Shrine","You find yourself in a holy sanctuary dimly lit by candles surrounding pictures of a sacred god.",new Items[]{}),null,null},
